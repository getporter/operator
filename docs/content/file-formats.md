...
In addition to the normal fields available on a [Porter Installation document](/docs/references/file-formats/installation/), the following fields are supported:
